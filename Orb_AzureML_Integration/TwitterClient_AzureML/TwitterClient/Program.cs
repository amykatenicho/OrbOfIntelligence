...
namespace TwitterClient
{
    class Program
    {
        ...
        public static int SentimentValue(string inputText, HttpClient httpClient)
        {
            ...
            //IF statement to chekc for 0 Exception
        ...
        static void Main(string[] args)
        {
            ...
            keywords)).Select(tweet => Sentiment.ComputeScore(tweet, keywords)).Select(tweet => new Payload { CreatedAt = Convert.ToDateTime(tweet.CreatedAt), Topic = tweet.Topic, Text = tweet.Text });
